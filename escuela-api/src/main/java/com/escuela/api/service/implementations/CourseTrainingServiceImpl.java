...
public class CourseTrainingServiceImpl implements CourseTrainingService {
    ...
    private Mail getMailDetails(CourseTraining trainee) {
        ...
        mail.setSubject("[Escuela-Technologies] Training Registration");
        mail.setFrom("Escuela Technologies");
        mail.setMessage("AWS Training Registration confirmed for <b> "+trainee.getLastName()+","+trainee.getFirstName()+"</b>");
...
//                "The meeting will be held on Feb 6, 2021 at 10:00am");
        mail.setAck("You will receive further communication from us regarding the training timings. " +
                "if you have questions please drop an email at <i> escuela.tech@gmail.com <i>" );
